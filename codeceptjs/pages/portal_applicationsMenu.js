...
module.exports = {
  ...
  locators1: {
    application1: { xpath: '//a[@href="/apps"]' },
    createApplication1: { xpath: '//a[@href="/apps/application/create"]' },
    enable: { xpath: '/html/body/div[1]/div/div/form/div/div[1]/div/button[1]' },
  },
  createApplicationLocators1: {
    addImage: { xpath: '//div[contains(@class,"application logo")]' },
    applicationName1: { id: 'name' },
    description1: { id: 'description' },
    phone1: { id: 'phone' },
    email1: { id: 'email' },
    enableApplication1: { xpath: '/html/body/div/div[1]/div/div/div[3]/form/fieldset/div[7]/div/div/label/input' },
    saveApplication1: { id: 'application-save-and-list-button' },
    saveAndAddAuthentication1: { xpath: '/html/body/div/div[1]/div/div/div[3]/form/div[2]/button[2]' },
    cancel1: { xpath: '/html/body/div/div[1]/div/div/div[3]/form/div[2]/button[3]' },
    back1: { xpath: '/html/body/div/div[1]/div/div/div[2]/a' }
  },
  ...
  createApplication1() {
    I.fillField(this.createApplicationLocators1.applicationName1, 'Auto Application');
    I.fillField(this.createApplicationLocators1.description1, 'This is an application created with automation test');
    I.fillField(this.createApplicationLocators1.phone1, '12345678');
    I.fillField(this.createApplicationLocators1.email1, 'autoapp@autoapp.com');
    I.click(this.createApplicationLocators1.saveApplication1);
  },
  clickCreateApplication1() {
    I.click(this.locators1.application1);
    I.wait();
    I.click(this.locators1.createApplication1);
    I.seeInCurrentUrl('/apps/application/create');
    I.see('Create Application');
  }
}