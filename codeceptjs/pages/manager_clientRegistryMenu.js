...
module.exports = {
  ...
  locators1: {
    oraganizations1: { xpath: '//li[contains(text(),"Organizations")]' },
    applicationDevelopers1: { xpath: '//li[contains(text(),"Application Developers")]' }
  },
  organizationLocators1: {
    newOrganization1: { xpath: '//span[text()="New organization"]' },
    organizationName1: { xpath: '//label[text()="*Organization name:"]/../div/div/div[2]/input' },
    toggleApiDevelopmentOn1: { xpath: '//label[contains(.,"API Devel")]/following-sibling::div//table//td[2]/div[1]' },
    toggleApiDevelopmentOff: { xpath: '/html/body/div[5]/div/table/tbody/tr/td/div/div[2]/div/div/div/div/div/div/fieldset[1]/div[5]/div/div/table/tbody/tr/td[2]/div[1]' },
    toggleAddApi: { xpath: '' },
    create1: { xpath: '//span[text()="Create"]' },
    cancel1: { xpath: '/html/body/div[5]/div/div[2]/div/div[2]/div/div[1]/span[4]/span/span/span[3]' },
    genearateCode: { xpath: '//span[text()="Generate code"]'},
    genearate: { xpath: '//span[text()="Generate"]'},
    generatedCode: {xpath: '//span[text()="Code"]/../../../../../tbody/tr/td[2]/div/div/input'}
  },
  applicationDeveloperLocators1: {
    newUser1: { xpath: '//span[text()="New user"]' },
    loginName1: { xpath: '//label[text()="*Login name:"]/../div/div/div[2]/input' },
    name1: { xpath: '//label[text()="*Name:"]/../div/div/div[2]/input' },
    email1: { xpath: '//label[text()="*Email:"]/../div/div/div[2]/input' },
    toggleOrganization1: { xpath: '//label[text()="*Organization:"]/../div/table/tbody/tr/td[2]/input' },
    selectOrganization1: { xpath: '//span[text()="Automation Organization"]' },
    toggleRole1: { xpath: '//label[text()="*Role:"]/../div/table/tbody/tr/td[2]/input' },
    selectRoleUser1: { xpath: '//span[text()="User"]' },
    create1: { xpath: '//span[text()="Create"]' },
    back1: { xpath: '//span[text()="Back"]' },
    cancel1: { xpath: '//span[text()="Cancel"]' },
  },
  applicationDeveloperChangePwdLocators1: {
    changePassword1: { xpath: '(//span[text()="Change password"])[1]' },
    newPassword1: { xpath: '//label[text()="*New password:"]/../div/div/div[2]/input' },
    verifyNewPassword1: { xpath: '//label[text()="*Verify new password:"]/../div/div/div[2]/input' },
    changePasswordPopup1: { xpath: '(//span[text()="Change password"])[4]' },
    cancel1: { xpath: '//*[@id="dijit_form_Button_110_label"]' },
    ok1: { xpath: '//span[text()="Ok"]' }
  },
  clickOrganizations() {
  ...
  clickOrganizations1() {
    I.click(this.locators1.oraganizations1);
  },
  createAutomationOrganization1() {
    I.click(this.organizationLocators1.newOrganization1);
    I.fillField(this.organizationLocators1.organizationName1, 'Automation Organization');
    I.click(this.organizationLocators1.toggleApiDevelopmentOn1);
    I.click(this.organizationLocators1.create1);
  },
  createAutomationOrganizationWithGenerateCode1() {
    I.click(this.organizationLocators1.newOrganization1);
    I.fillField(this.organizationLocators1.organizationName1, 'Automation Organization');
    I.click(this.organizationLocators1.toggleApiDevelopmentOn1);
    I.click(this.organizationLocators1.create1);
    I.wait(10);
    I.click(this.organizationLocators1.genearateCode);
    I.wait(2);
    I.click(this.organizationLocators1.genearate)
    I.wait(5);
    var generatedCode = yield I.grabTextFrom(this.organizationLocators1.generatedCode);
  },
  clickApplicationDevelopers1() {
    I.wait();
    I.click(this.locators1.applicationDevelopers1);
  },
  createAppDeveloper1() {
    I.click(this.applicationDeveloperLocators1.newUser1);
    I.fillField(this.applicationDeveloperLocators1.loginName1, 'AppDeveloper');
    I.fillField(this.applicationDeveloperLocators1.name1, 'AppDeveloper');
    I.fillField(this.applicationDeveloperLocators1.email1, 'appdeveloper@mail.com');
    I.click(this.applicationDeveloperLocators1.toggleOrganization1);
    I.click(this.applicationDeveloperLocators1.selectOrganization1);
    I.click(this.applicationDeveloperLocators1.toggleRole1);
    I.click(this.applicationDeveloperLocators1.selectRoleUser1);
    I.scrollTo(0, 0);
    I.click(this.applicationDeveloperLocators1.create1);
    I.wait(2);
    //Change the password
    I.scrollTo(this.applicationDeveloperChangePwdLocators1.changePassword1);
    I.click(this.applicationDeveloperChangePwdLocators1.changePassword1);
    I.fillField(this.applicationDeveloperChangePwdLocators1.newPassword1, 'SECRET123');
    I.fillField(this.applicationDeveloperChangePwdLocators1.verifyNewPassword1, 'SECRET123');
    I.wait(2);
    I.click(this.applicationDeveloperChangePwdLocators1.changePasswordPopup1);
    I.wait(2);
    I.click(this.applicationDeveloperChangePwdLocators1.ok1);
    I.wait(2);
  }
}
